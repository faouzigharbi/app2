// Émet une page par EXERCICE de la fiche « الجمع في ℝ » (9 أساسي), plus l'index.
...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">➕ الجمع في ℝ</span>
...
['noyau.js', 'algebre.js', 'exercices.js', 'gens.js'].forEach(f =>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>الجمع في ℝ — 9 أساسي</title>
</head>
<body>
<h3>➕ الجمع في ℝ — أنواع شاملة</h3>
<p style="text-align:center;color:#95a5a6;font-size:.9em;margin-bottom:16px">
  ...
  صفحة لكل تمرين؛ الأعداد و الأعداد الصمّاء تتغيّر في كل تحميل
</p>
