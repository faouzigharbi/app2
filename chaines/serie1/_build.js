// Émet les 11 paires exNN.js / exNN.html + index.html.
//   node _build.js .
const fs = require('fs');
const path = require('path');
const { EXERCICES } = require('./generateurs.js');
...
(function(){
  ...
  document.getElementById('btnNew').addEventListener('click', function() {
    data = window.Generateurs.construire(window.exerciceNumero);
    currentQ = 0;
    score = 0;
    loadQuestion();
  });
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>سلسلة تمارين عدد 1 — العمليات على الأعداد الصحيحة الطبيعية</title>
</head>
<body>
<h3>🎲 سلسلة تمارين عدد 1 — العمليات على الأعداد الصحيحة الطبيعية</h3>
<p style="text-align:center;color:#95a5a6;font-size:.9em;margin-bottom:16px">
  7 أساسي — ${total} عملية في ${liens.length} تمرين<br>
