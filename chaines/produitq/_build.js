...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">✖️ الجداء و القسمة في ℚ</span>
...
(function(){
  ...
  document.getElementById('btnNew').addEventListener('click', function() {
    data = window.Produit.construire(window.exerciceNumero);
    construire();
    window.scrollTo(0, 0);
  });
...
['noyau.js', 'produits.js', 'gens.js'].forEach(f =>
...
for (const n of EXOS) {
  ...
  fs.writeFileSync(path.join(OUT, id + '.js'),
    ...
    + `window.exerciceData = Produit.construire(${n});\n`);
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>الجداء و القسمة في ℚ</title>
</head>
<body>
<h3>✖️ الجداء و القسمة في ℚ — تمارين شاملة</h3>
