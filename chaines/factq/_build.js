...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">🧩 التفكيك في ℚ</span>
...
(function(){
  ...
  document.getElementById('btnNew').addEventListener('click', function() {
    data = window.Fact.construire(window.exerciceNumero);
    construire();
    window.scrollTo(0, 0);
  });
...
['noyau.js', 'fact.js', 'gens.js'].forEach(f =>
...
for (const n of EXOS) {
  ...
  fs.writeFileSync(path.join(OUT, id + '.js'),
    ...
    + `window.exerciceData = Fact.construire(${n});\n`);
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>التفكيك في ℚ</title>
</head>
<body>
<h3>🧩 التفكيك في ℚ — تمارين شاملة</h3>
