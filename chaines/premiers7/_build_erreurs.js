...
const F = require('./pont.js');

require('./moteur.js');
require('./generateurs.js');
...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">7 أساسي — الأعداد الأوّلية</span>
...
(function(){
  ...
  const R = window.Pont, E = window.Erreurs;
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>أين الخطأ؟ — 7 أساسي — الأعداد الأوّلية</title>
<link rel="stylesheet" href="../style.css">
</head>
<body>
<header><h1>أين الخطأ؟ — 7 أساسي — الأعداد الأوّلية</h1>
