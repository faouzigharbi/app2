...
['noyau.js', 'formes.js', 'questions.js', 'equations.js', 'gens.js'].forEach(f =>
...
for (const n of EXOS) {
  ...
  fs.writeFileSync(path.join(OUT, id + '.js'),
    ...
    + `window.exerciceData = AddZ.construire(${n});\n`);
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>جمع و طرح الأعداد الصحيحة النسبية</title>
</head>
<body>
<h3>➕ جمع و طرح الأعداد الصحيحة النسبية — تمارين شاملة</h3>
