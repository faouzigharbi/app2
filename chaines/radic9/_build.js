// Émet une page par EXERCICE de la fiche « العمليات في ℝ » (9 أساسي), plus l'index.
...
(function(){
  ...
  document.getElementById('btnNew').addEventListener('click', function() {
    data = window.Radic.construire(window.exerciceNumero);
    construire();
    window.scrollTo(0, 0);
  });
...
['noyau.js', 'racines.js', 'exercices.js', 'gens.js'].forEach(f =>
...
for (const n of EXOS) {
  ...
  fs.writeFileSync(path.join(OUT, id + '.js'),
    ...
    + `window.exerciceData = Radic.construire(${n});\n`);
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>العمليات في ℝ — جذور تربيعية — 9 أساسي</title>
</head>
<body>
<h3>√ العمليات في ℝ — أنواع شاملة</h3>
<p style="text-align:center;color:#95a5a6;font-size:.9em;margin-bottom:16px">
  ...
  صفحة لكل عائلة؛ الأعداد و الجذور تتغيّر في كل تحميل
</p>
