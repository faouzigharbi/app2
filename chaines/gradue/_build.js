...
<head>
  ...
  <title>${titre}</title>
  <style>
    .fig { margin-top:10px; overflow-x:auto; text-align:center }
...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">📏 بعد نقطتين من مستقيم مدرج</span>
...
(function(){
  ...
  document.getElementById('btnNew').addEventListener('click', function() {
    data = window.Gradue.construire(window.exerciceNumero);
    construire();
    window.scrollTo(0, 0);
  });
...
['noyau.js', 'droite.js', 'outils.js', 'gens.js'].forEach(f =>
...
for (const n of EXOS) {
  ...
  fs.writeFileSync(path.join(OUT, id + '.js'),
    ...
    + `window.exerciceData = Gradue.construire(${n});\n`);
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>بعد نقطتين من مستقيم مدرج</title>
</head>
<body>
<h3>📏 بعد نقطتين من مستقيم مدرج — تمارين شاملة</h3>
