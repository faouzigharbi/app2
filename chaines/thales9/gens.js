...
(function (racine) {
  ...
  const FAMILLES = [
    ...
    ['thales-inconnues', 'نظرية طالس — أحسب x و y و z'],
    ['thales-cas', 'نظرية طالس — أوجد البعد المطلوب في كلّ حالة'],
    ['thales-part', 'نظرية طالس — المجهول في الطّرفين'],
    ['angles-paralleles', 'زاويتان متبادلتان داخليا — التوازي ثمّ طالس'],
