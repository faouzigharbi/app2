...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">التفكيك في ℚ — 8 أساسي</span>
...
(function(){
  ...
  const R = window.Fact, E = window.Erreurs;
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>أين الخطأ؟ — التفكيك في ℚ — 8 أساسي</title>
<link rel="stylesheet" href="style.css">
</head>
<body>
<header><h1>أين الخطأ؟ — التفكيك في ℚ — 8 أساسي</h1>
