...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">8 أساسي — ترتيب الأعداد الناطقة</span>
...
(function(){
  ...
  const R = window.Frac, E = window.Erreurs;
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>أين الخطأ؟ — 8 أساسي — ترتيب الأعداد الناطقة</title>
<link rel="stylesheet" href="style.css">
</head>
<body>
<header><h1>أين الخطأ؟ — 8 أساسي — ترتيب الأعداد الناطقة</h1>
