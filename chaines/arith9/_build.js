// Émet une page par EXERCICE de la fiche « الحساب » (9 أساسي), plus l'index.
...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">🔢 الحساب و القابلية للقسمة</span>
...
<script src="puissances.js"></script>
...
['noyau.js', 'criteres.js', 'puissances.js', 'gens.js'].forEach(f =>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>الحساب و القابلية للقسمة — 9 أساسي</title>
</head>
<body>
<h3>🔢 الحساب و القابلية للقسمة — أنواع شاملة</h3>
<p style="text-align:center;color:#95a5a6;font-size:.9em;margin-bottom:16px">
  9 أساسي — ${liens.length} تمارين، ${total} سؤالا في كل تحميل<br>
  صفحة لكل تمرين، بكل أسئلته في آن واحد؛ الأعداد و النماذج تتغيّر في كل تحميل
</p>
