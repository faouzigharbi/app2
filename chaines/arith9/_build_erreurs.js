...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">الحساب و القوى — 9 أساسي</span>
...
(function(){
  ...
  const R = window.Arith, E = window.Erreurs;
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>أين الخطأ؟ — الحساب و القوى — 9 أساسي</title>
<link rel="stylesheet" href="style.css">
</head>
<body>
<header><h1>أين الخطأ؟ — الحساب و القوى — 9 أساسي</h1>
