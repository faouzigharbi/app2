...
(function (racine) {
  ...
  page(18, 'عددان محصوران، ثمّ اختصار عبارة بجذرين و قيمة مطلقة', V.exercice18, 6);
  page(19, 'من حصر واحد إلى تفكيك، ثمّ حصر لجداء', V.exercice19, 5);
  page(20, 'عبارة من الدرجة الثانية، ثمّ مساحتان', V.exercice20, 9);
