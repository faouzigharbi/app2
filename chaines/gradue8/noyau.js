// Noyau de la fiche « بعد نقطتين من مستقيم مدرج » (8 أساسي).
//
...
(function (racine) {
  ...
  // La figure, quand il y en a une, se pose sous l'énoncé. Elle est en SVG :
  // aucun risque de retournement bidi, et elle reste nette à toute taille.
  ...
  function rendre(brut) {
    return {
      operation: (brut.enonceComplet || brut.enonce).map(rendreMath).join(' ')
