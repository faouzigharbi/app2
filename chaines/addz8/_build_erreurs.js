...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">الجمع و الطرح في ℤ — 8 أساسي</span>
...
(function(){
  ...
  const R = window.AddZ, E = window.Erreurs;
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>أين الخطأ؟ — الجمع و الطرح في ℤ — 8 أساسي</title>
<link rel="stylesheet" href="style.css">
</head>
<body>
<header><h1>أين الخطأ؟ — الجمع و الطرح في ℤ — 8 أساسي</h1>
