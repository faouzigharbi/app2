...
(function (racine) {
  ...
  const F = M ? require('./pont.js') : racine.Pont;
  ...
  const FAMILLES = [
    {
      ...
      quoi: "الضرب و القسمة قبل الجمع و الطرح: 26 × 9 + 3 = 234 + 3، و ليس 26 × (9 + 3)",
    ...
    },
    {
      ...
      quoi: "إعادة التجميع تُبقي قيمة العبارة: 487 + (373 - 73) و ليس 487 + (373 + 73)",
    ...
    },
    {
      ...
      quoi: "إعادة ترتيب العوامل تُبقي الجداء جداء: 50 × 80 × 2 = (50 × 2) × 80، و القوس هنا جداء لا مجموع",
    ...
    },
    {
      ...
      quoi: "عند نشر k × (a + b) يُضرب k في الحدّين: 37 × (37 + 63)، و ليس 37 × 37 + 63",
    ...
    },
    {
      ...
      quoi: "(أ − ج) − (ب − ج) = أ − ب، و (أ − ج) + (ب + ج) = أ + ب : الإشارة النهائية تُقرأ في القاعدة، لا تُخمَّن",
      geste: /نطبّق القاعدة/,
      faire: function(math) {
          const t = String(math).trim();
          if (/[=a-zA-Zأ-ي()]/.test(t)) return null;
    ...
    },
    {
      ...
      quoi: "للبحث عن الحدّ المجهول في مجموع نطرح: 55 + ... = 65 يعطي 65 - 55، لا 65 + 55",
      geste: /نحسب/,
      faire: function(math) {
          const t = String(math).trim();
          if (/[=a-zA-Zأ-ي()]/.test(t)) return null;
