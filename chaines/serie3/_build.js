// Émet une page par EXERCICE de la fiche « الضرب و القسمة في مجموعة الأعداد الحقيقية »,
// plus l'index.
...
<main>
  <div id="barre" class="row">
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <span class="badge">× الضرب و القسمة في ℝ</span>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style.css">
  <title>الضرب و القسمة في مجموعة الأعداد الحقيقية — سلاسل البرهان</title>
</head>
<body>
<h3>× الضرب و القسمة في مجموعة الأعداد الحقيقية — سلاسل البرهان</h3>
